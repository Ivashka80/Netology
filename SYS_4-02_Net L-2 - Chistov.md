...
Сначала была сделана сеть с резервным каналом. В данной схеме работает протокол STP, чтобы избежать широковещательный шторм и потому один порт заблокирован (желтая метка на Switch0).

![Снимок2](https://user-images.githubusercontent.com/121082757/219850395-07cda6c9-afc8-4e25-8b1e-469b156d8ac9.PNG)

Для проверки работоспособности был отключен работающий порт командой Shutdown. И через некоторое время пакеты пошли уже по другому пути.
